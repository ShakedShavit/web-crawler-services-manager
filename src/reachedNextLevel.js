const { setHashValuesInRedis, getHashValuesFromRedis } = require("./utils/redis");
const { createQueue, deleteQueue } = require("./utils/sqs");

const crawlReachedNextLevel = async (queueName, crawlHashKey) => {
    let [currentLevel, currQueueUrl, nextQueueUrl, maxDepth, currLvlLinksLen, nextLvlLinksLen] =
        await getHashValuesFromRedis(crawlHashKey, [
            "currentLevel",
            "currQueueUrl",
            "nextQueueUrl",
            "maxDepth",
